...
public class UsedCarsSearchPageActions {
	...
	public void selectCarMaker(String carBrand)
	{
		...
		SeleniumDriver.getDriver().findElement(By.xpath("//li[@class='uhf-menu-item uhf-dropdown-menu-toggle uhf-menu-buysell']//div[@class='uhf-child-expand']//div[@class='uhf-child-content']//div[@class='uhf-child-menu']//ul//li//a[contains(text(),'Used')] ")).click(); 
